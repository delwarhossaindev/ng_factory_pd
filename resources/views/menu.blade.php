...
<div class="manage-menus">
    <form method="get" action="{{ $currentUrl }}">
        ...
        {!! \App\Helpers\MenuManager::select('menu', $menulist) !!}
...
<div id="nav-menus-frame">
    ...
    <x-slot name="script">
        ...
        <script src="{{ asset('admin/menu/js/script.js') }}"></script>
        <script src="{{ asset('admin/menu/js/plugin.js') }}"></script>
