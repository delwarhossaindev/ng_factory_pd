                   ...
                   <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <div class="header">
                           <table class="table borderless">
                            <tr>
                            <td><p class="m-0 d-flex justify-content-between">New Product Category <span class="pe-5">:</span></p></td>
                            <td>
                                <input type="checkbox"   {{ $proposal->ProductCategory === 'New Molecule' ? 'checked' : '' }}> New Molecule &nbsp;
                                <input type="checkbox"   {{ $proposal->ProductCategory === 'Line Extension' ? 'checked' : '' }}> Line Extension
                            </td>
                            </tr>
                            <tr>
                            <td><p class="m-0 d-flex justify-content-between">Reference Status  <span class="pe-5">:</span></p></td>
                            <td colspan="3">
                                @foreach ($referenceStatuses as $status)
                                    <input type="checkbox"  {{ in_array($status, $saveStatus) ? 'checked' : '' }}> {{ $status }} &nbsp;
                            @endforeach
                            </td>
                            </tr>
                            ...
                            <tr>
                            <td><p class="m-0 d-flex justify-content-between">Generic Name<span class="pe-5">:</span></p> </td>
                            ...
                            <tr>
                            <td><p class="m-0 d-flex justify-content-between">Indication <span class="pe-5">:</span></p> </td>
                            <td colspan="3">{{ $proposal->generalInfo->Indication ?? 'N/A' }}</td>
                            </tr>

                            <tr>
                            <td><p class="m-0 d-flex justify-content-between">Local Competitors <span class="pe-5">:</span></p> </td>
                    ...
                    <div class="row">
                        <div class="col-sm-12  table-responsive">
                            <table class="table table-sm table-bordered">
                                <thead>
                                    <tr>
                                        <th class="text-center text-capitalize" style=" border: 1px solid #000;">Strength & Dosage Form</th>
                                        <th class="text-center text-capitalize" style=" border: 1px solid #000;">Pack <br> Size</th>
                                        <th class="text-center text-capitalize" style=" border: 1px solid #000;">Primary Pack</th>
                                        ...
                                        <th class="text-center text-capitalize" style=" border: 1px solid #000;">TP/Pack<br>(Tk.)</th>
                                        <th class="text-center text-capitalize" style=" border: 1px solid #000;">DCC <br> Number</th>
                                        <th class="text-center text-capitalize" style=" border: 1px solid #000;">Availability in <br> BD</th>
                                    </tr>
                                </thead>
                                <tbody id="services">
                        ...
                        <div class="col-sm-12  table-responsive">
                            <table class="table table-sm table-bordered align-middle">
                                ...
                                <thead class=" border-b">
                                    <tr>
                                        <th scope="col" class="text-center border-b bg-transparent" style="width: 20%;  border: 1px solid #000;" >Designation</th>
                                        <th scope="col" class="text-center border-b bg-transparent" style="width: 35%;  border: 1px solid #000;">Comments</th>
                                        <th scope="col" class="text-center border-b bg-transparent" style="width: 15%;  border: 1px solid #000; width:20%">Action</th>
                                        <th scope="col" class="text-center border-b bg-transparent signature-header" style="width: 35%; border: 1px solid #000; ">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="empty-state " style=" border: 1px solid #000;">
                                         <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" {{$TopManagement1 && $TopManagement1->StatusID == 1 ? 'checked' : '' }} >
                                            <label class="form-check-label" for="recommendedCheck">Recommended</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" {{$TopManagement1 && $TopManagement1->StatusID == 2 ? 'checked' : '' }} >
                                            <label class="form-check-label" for="notRecommendedCheck">Not recommended</label>
                                        </div>
                                        </td>
                                        <td class="empty-state text-center" style=" border: 1px solid #000;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="empty-state" style=" border: 1px solid #000;">
                                           <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" {{$TopManagement2 && $TopManagement2->StatusID == 1 ? 'checked' : '' }} >
                                            <label class="form-check-label" for="recommendedCheck">Recommended</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" {{$TopManagement2 && $TopManagement2->StatusID == 2 ? 'checked' : '' }} >
                                            <label class="form-check-label" for="notRecommendedCheck">Not recommended</label>
                                        </div>
                                        </td>
                                        <td class="empty-state text-center" style=" border: 1px solid #000;">
                                    ...
                                    <tr style=" border: 1px solid #000;">
                                        ...
                                        <td class="empty-state ">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" {{$TopManagement3 && $TopManagement3->StatusID == 1 ? 'checked' : '' }} >
                                            <label class="form-check-label" for="recommendedCheck" >Recommended</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" {{ $TopManagement3 && $TopManagement3->StatusID == 2 ? 'checked' : '' }}>
                                            <label class="form-check-label" for="notRecommendedCheck">Not recommended</label>
                                        </div>
                                        </td>
                                        <td class="empty-state text-center" style=" border: 1px solid #000;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="empty-state" style=" border: 1px solid #000;">
                                          <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" {{$TopManagement4 && $TopManagement4->StatusID == 1 ? 'checked' : '' }} >
                                            <label class="form-check-label" for="recommendedCheck">Recommended</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" {{ $TopManagement4 && $TopManagement4->StatusID == 2 ? 'checked' : '' }} >
                                            <label class="form-check-label" for="notRecommendedCheck">Not recommended</label>
                                        </div>
                                        </td>
                                        <td class="empty-state text-center" style=" border: 1px solid #000;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="empty-state" style=" border: 1px solid #000;">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" {{$TopManagement5 && $TopManagement5->StatusID == 1 ? 'checked' : '' }} >
                                            <label class="form-check-label" for="recommendedCheck">Recommended</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" {{$TopManagement5 && $TopManagement5->StatusID == 2 ? 'checked' : '' }} >
                                            <label class="form-check-label" for="notRecommendedCheck">Not recommended</label>
                                        </div>
                                        </td>
                                        <td class="empty-state text-center" style=" border: 1px solid #000;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="empty-state " style=" border: 1px solid #000;">
                                           <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" {{$TopManagement6 && $TopManagement6->StatusID == 1 ? 'checked' : '' }} >
                                            <label class="form-check-label" for="recommendedCheck">Recommended</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" {{ $TopManagement6 && $TopManagement6->StatusID == 2 ? 'checked' : '' }} >
                                            <label class="form-check-label" for="notRecommendedCheck">Not recommended</label>
                                        </div>
                                        </td>
                                        <td class="empty-state text-center" style=" border: 1px solid #000;">
